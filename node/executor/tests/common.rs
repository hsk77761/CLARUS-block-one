...
use clarus_node_executor as node_executor;
use clarus_runtime::{
...
pub fn compact_code_unwrap() -> &'static [u8] {
    clarus_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = clarus_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = clarus_runtime::VERSION.transaction_version;
...
pub fn construct_block(
    ...
    executor_call(env, "Core_initialize_block", &header.encode(), true)
        .0
        .unwrap();
    ...
    let header = Header::decode(
        &mut &executor_call(env, "BlockBuilder_finalize_block", &[0u8; 0], true)
            .0
            .unwrap()[..],
    )
    .unwrap();
