...
impl pallet_democracy::Config for Runtime {
	...
	type FastTrackOrigin =
		pallet_collective::EnsureProportionAtLeast<AccountId, config::TechnicalCollective, 2, 3>;
	type InstantOrigin =
		pallet_collective::EnsureProportionAtLeast<AccountId, config::TechnicalCollective, 1, 1>;
	...
	type VetoOrigin = pallet_collective::EnsureMember<AccountId, config::TechnicalCollective>;
...
impl pallet_membership::Config<pallet_membership::Instance1> for Runtime {
	...
	type MaxMembers = config::TechnicalMaxMembers;
